              ...
              <table className="data-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>14 Feb 2019</td>
                    <td>Electric</td>
                    <td className="status-cell"><span className="status status-completed">{t('Completed')}</span></td>
                  </tr>
                  <tr>
                    <td>00002</td>
                    <td>Rosie Pearson</td>
                    ...
                    <td>14 Feb 2019</td>
                    <td>Book</td>
                    <td className="status-cell"><span className="status status-processing">{t('Processing')}</span></td>
                  </tr>
                  <tr>
                    <td>00003</td>
                    ...
                    <td>14 Feb 2019</td>
                    <td>Medicine</td>
                    <td className="status-cell"><span className="status status-rejected">{t('Rejected')}</span></td>
                  </tr>
                  <tr>
                    <td>00004</td>
