            ...
            <div className="contact-fields">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input type="text" id="phone" className="form-input" placeholder="Enter Phone Number" />
                </div>
              </div>
              <div className="form-row">
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <select id="gender" className="form-input" value={gender} onChange={handleGenderChange}>
